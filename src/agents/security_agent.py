...
class SecurityAgent:
    ...
    def __init__(self):
        ...
        self.suspicious_keywords = [
            "admin", "root", "password", "secret", "key", "token", "api_key",
            "database", "server", "config", "settings", "environment",
            "shell", "terminal", "command", "script", "exec", "eval",
    ...
    async def analyze_security(self, input_text: str) -> dict[str, any]:
        ...
        try:
            ...
            logger.info(f"Security analysis completed: safe={analysis['is_safe']}, threat_level={analysis['threat_level']}")
            return analysis
    ...
    def _determine_threat_level(self, threats: list[str]) -> str:
